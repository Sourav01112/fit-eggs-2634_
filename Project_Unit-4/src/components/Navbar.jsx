      ...
      <Box>
        {showBox && (
          <Flex alignItems="center" backgroundColor="black">
            <Box flex={1} className="tempBanner">
              <Text
                textAlign={"center"}
                className="textInTemp"
                //   fontSize={20}
                color="white"
              >
                NOW SHOPPING AT{" "}
                <span style={{ color: "red" }}> MEMBERSHIP </span>PRICES
              </Text>
            </Box>
        ...
        <Flex className="NavBar" bg="#E11B23" color="white" p="3" height="42px">
          <Link to="/">
            <Box m="-12px" mt={"2px"}>
            ...
            <Tabs index={tabIndex} onChange={handleTabChange} mt="-11px">
              <TabList>
                ...
                <Tab
                  ...
                  _selected={{ color: "black", bg: "white" }}
                >
                  <Link to="/kids" fontWeight="extrabold">
                    KIDS
                  </Link>
                </Tab>
              </TabList>
