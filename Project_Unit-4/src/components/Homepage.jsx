  ...
  return (
    <div>
      ...
      <div className="collectionsContainer">
        <HomeCard
          src={`https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/product-images/new-arrival_K4kSjL3.jpg?format=webp&w=480&dpr=1.4`}
        />

        <HomeCard
          src={`https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/product-images/Colllection-Tile2_JiJDYsX.jpg?format=webp&w=480&dpr=1.4`}
        />

        <HomeCard
          src={`https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/product-images/Colllection-Tile1_lwye5cS.jpg?format=webp&w=480&dpr=1.4`}
        />
      </div>
      ...
      <div
        className="catgoriesContainer"
        //   style={{ display: "flex" }}
      >
        <HomeCard
          src={`https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/product-images/WebsiteTiles_Big_Women-version6.jpg?format=webp&w=480&dpr=1.4`}
        />

        <Link to="/women">
          <HomeCard
            src={`https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/product-images/WebsiteTiles_Big_Women-version5.jpg?format=webp&w=480&dpr=1.4`}
          />
        </Link>

        <HomeCard
          src={`https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/product-images/WebsiteTiles_Big_Women-version4.jpg?format=webp&w=480&dpr=1.4`}
        />
      </div>
      ...
      >
        <HomeCard
          src={`https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/product-images/WebsiteTiles_Big_Women-version3.jpg?format=webp&w=480&dpr=1.4`}
        />
        <HomeCard
          src={`https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/product-images/WebsiteTiles_Big_Women-version2.jpg?format=webp&w=480&dpr=1.4`}
        />
        <HomeCard
          src={`https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/product-images/WebsiteTiles_Big_Women-versiond.jpg?format=webp&w=480&dpr=1.4`}
        />
      </div>
      ...
      >
        <HomeCard
          src={`https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/product-images/WebsiteTiles_Small_women-version7.jpg?format=webp&w=330&dpr=1.4`}
        />

        <HomeCard
          src={`https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/product-images/WebsiteTiles_Small_women-version-14-02-233_kVU2vGa.jpg?format=webp&w=330&dpr=1.4`}
        />

        <HomeCard
          src={`https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/product-images/Small-Tile_shorts_3_1_qH2xOZD.jpg?format=webp&w=330&dpr=1.4`}
        />

        <HomeCard
          src={`https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/product-images/WebsiteTiles_Small_women-versionc.jpg?format=webp&w=330&dpr=1.4`}
        />
      </div>
      ...
      >
        <HomeCard
          src={`https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/product-images/Collection-tile_11_1.jpg?format=webp&w=480&dpr=1.4`}
        />

        <HomeCard
          src={`https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/product-images/Colllection-Tiles.jpg?format=webp&w=480&dpr=1.4`}
        />

        <HomeCard
          src={`https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/product-images/collection-tile_pretty-Pink_2_Jz32NqG_f9j62Lv.jpg?format=webp&w=480&dpr=1.4`}
        />
      </div>
